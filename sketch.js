...
function preload(){
  ...
  pink_balloonImage_balloonImage = loadImage("pink_balloon0.png")
...
function draw() {
 background(0);
  ...
  var selecy_balloon = Math.round(random(1,4))
  
  
  if (World.frameCount % 100 == 0) {
   switch(selecy_balloon){
...
function blueBalloon() {
  ...
  var blue = createSprite(0,Math.round(random(20, 370, 10, 10)), 10, 10)
